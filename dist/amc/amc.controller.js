...
let AmcController = class AmcController {
    ...
    findAll(companyId) { return this.service.findAll(companyId); }
    findOne(id, companyId) { return this.service.findOne(id, companyId); }
    update(id, dto) { return this.service.update(id, dto.companyId, dto); }
    remove(id, companyId) { return this.service.remove(id, companyId); }
};
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AmcController.prototype, "update", null);
__decorate([
